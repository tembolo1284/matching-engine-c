...
void test_FormatAck(void) {
    ...
    TEST_ASSERT_EQUAL_STRING("A, IBM, 1, 42\n", output);
...
void test_FormatCancelAck(void) {
    ...
    TEST_ASSERT_EQUAL_STRING("C, IBM, 2, 100\n", output);
...
void test_FormatTrade(void) {
    ...
    TEST_ASSERT_EQUAL_STRING("T, IBM, 1, 10, 2, 20, 150, 100\n", output);
...
void test_FormatTopOfBookBid(void) {
    ...
    TEST_ASSERT_EQUAL_STRING("B, IBM, B, 100, 500\n", output);
...
void test_FormatTopOfBookAsk(void) {
    ...
    TEST_ASSERT_EQUAL_STRING("B, IBM, S, 105, 300\n", output);
...
void test_FormatTopOfBookEliminatedBid(void) {
    ...
    TEST_ASSERT_EQUAL_STRING("B, IBM, B, -, -\n", output);
...
void test_FormatTopOfBookEliminatedAsk(void) {
    ...
    TEST_ASSERT_EQUAL_STRING("B, IBM, S, -, -\n", output);
