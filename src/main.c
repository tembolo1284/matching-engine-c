...
// Implement the lock-free queues for input and output messages
...
int main(int argc, char* argv[]) {
    ...
    fprintf(stderr, "==============================================================\n");
    fprintf(stderr, "Kraken Order Book - Multi-threaded Matching Engine (C Port)\n");
    fprintf(stderr, "==============================================================\n");
